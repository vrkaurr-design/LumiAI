   ...
   return (
     <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 relative">
       ...
       <Reveal className="w-full max-w-md mx-auto rounded-2xl border border-white/20 dark:border-white/10 bg-white/80 dark:bg-black/45 backdrop-blur-xl shadow-2xl p-6 relative z-10" variant="fade">
         <h2 className="text-2xl font-extrabold text-center mb-4 text-dark dark:text-white">Sign In</h2>
         <p className="text-sm mb-4 text-center text-gray-700 dark:text-gray-300">Sign in to continue your AI analysis.</p>
         ...
         <div className="mt-4 text-center text-sm">
           <a href="/signup" className="text-primary font-semibold">Create an account</a>
         </div>
       </Reveal>
     </div>
   );
