...
export default function SelfiePrep() {
  ...
  return (
          ...
          <ol className="list-decimal list-inside space-y-2 text-dark dark:text-white">
            <li>
              ...
              <ul className="list-disc list-inside pl-4 space-y-1 text-sm text-gray-700 dark:text-gray-300">
                <li>Use bright sunlight or evenly lit space.</li>
                <li>Face the light source; avoid backlighting.</li>
              </ul>
            </li>
            <li>
              No Makeup
              <ul className="list-disc list-inside pl-4 space-y-1 text-sm text-gray-700 dark:text-gray-300">
                <li>Skip foundation, concealer, lipstick, and tinted skincare.</li>
                <li>Avoid heavy products that leave films or glare.</li>
              </ul>
            </li>
            <li>
              Pose
              <ul className="list-disc list-inside pl-4 space-y-1 text-sm text-gray-700 dark:text-gray-300">
                <li>Keep a neutral expression; remove glasses.</li>
                <li>Hair away from face; camera at eye level.</li>
              </ul>
            </li>
            <li>
              Background
              <ul className="list-disc list-inside pl-4 space-y-1 text-sm text-gray-700 dark:text-gray-300">
                <li>Use a plain backdrop to reduce color cast.</li>
                <li>Avoid reflections and complex patterns.</li>
              </ul>
            </li>
          </ol>
        </Reveal>
    ...
    {camOpen && (
        <div className="mt-6">
          <div className="relative w-full max-w-3xl mx-auto rounded-2xl border border-white/20 dark:border-white/10 bg-white/90 dark:bg-black/60 backdrop-blur-xl shadow-2xl p-6 max-h-[85vh] overflow-y-auto overflow-x-hidden box-border">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-lg font-extrabold text-dark dark:text-white">Camera Access</h2>
              <button onClick={closeCamera} className="rounded-md px-2 py-1 bg-white/70 dark:bg-white/10 text-dark dark:text-white hover:bg-white/90 dark:hover:bg-white/20">✕</button>
            </div>
            {!ready && (
            ...
            <div className="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <button
                onClick={(e) => { handleRipple(e); setShowNote(true); setTimeout(() => { closeCamera(); router.push("/skin-analysis"); }, 900); }}
                disabled={!photoUrl}
